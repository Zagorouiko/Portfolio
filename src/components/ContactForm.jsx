...
export default function ContactForm() {
    ...
    const [formSubmitted, setFormSubmitted] = useState(false);
      ...
      const handleSubmit = async (e) => {
        ...
        //     const response = await fetch('https://savage-garden-8e230876a8ae.herokuapp.com/api/send-email', {
        //       method: 'POST',
        //       headers: {
  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-12 mx-36 mb-10 max-xl:mx-14">
