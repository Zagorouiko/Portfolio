...
export default function ContactForm() {
    ...
    const [formSubmitted, setFormSubmitted] = useState(false);
      ...
      const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://zagorouiko.com/send-email', formData, {
              headers: {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} autoComplete="off" className="grid grid-cols-12 mx-36 max-xl:mx-14">
      <div className="col-span-6 mr-4">
                      ...
                      <input
                          ...
                          className="contactInput block w-full border-0 bg-white/5 px-2 py-1.5 text-white shadow-sm sm:text-sm sm:leading-6"
                      />
                      </div>
                  </div>
                  ...
                  <label htmlFor="last-name" className="text-base font-semibold leading-6 text-[#D9D9D9]">
                      ...
                      <input
                          ...
                          onChange={handleChange}
                          autoComplete="off"
                          className="contactInput block w-full border-0 px-2 bg-white/5 py-1.5 text-white shadow-sm sm:text-sm sm:leading-6"
                      />
                      </div>
                  </div>
                  ...
                  {formSubmitted ?
                  (<p className="mt-2 py-2 text-left w-[24rem] text-sm font-semibold text-[#D9D9D9]">Successfully submitted form! I'll contact you soon</p>)
                  :
                  (<button
                  type="submit"
                ...
                >
                  <div className="ml-12">SEND</div> 
                </button>)}
          </form>
          <style>
            {`
              input.contactInput:focus, textarea:focus {
                outline: none;
                caret-color: white;
